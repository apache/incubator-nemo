 ...
 */
public final class UnboundedTextSource extends UnboundedSource<String, UnboundedSource.CheckpointMark> {
  private static final long serialVersionUID = 1L;

  @Override
  public List<? extends UnboundedSource<String, CheckpointMark>> split(
      final int desiredNumSplits, final PipelineOptions options) throws Exception {
  ...
  @Override
  public UnboundedReader<String> createReader(final PipelineOptions options,
   ...
   * reads from text.
   */
  public final class UnboundedTextReader extends UnboundedReader<String> implements Serializable {
    ...
    public UnboundedTextReader(final UnboundedTextSource source) {
      this.source = source;
    }
    ...
    public boolean advance() throws IOException {
      ...
      try {
        Thread.sleep(index * 1000); // slow down streaming speed
