 ...
 */
public final class StateMergerVertex extends OperatorVertex {
  /**
   * Constructor.
   */
  public StateMergerVertex(final OperatorVertex operatorVertex) {
    super(operatorVertex.getTransform());
  }
}
