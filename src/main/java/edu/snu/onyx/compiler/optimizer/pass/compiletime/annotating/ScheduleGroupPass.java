...
import edu.snu.onyx.compiler.ir.executionproperty.vertex.ScheduleGroupIndexProperty;

import java.util.*;
import java.util.stream.Collectors;
import java.util.stream.Stream;

import static edu.snu.onyx.compiler.ir.executionproperty.ExecutionProperty.Key.StageId;
