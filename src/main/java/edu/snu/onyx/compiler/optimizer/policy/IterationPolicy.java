...
/**
 * A policy to perform loop extraction.
 */
public final class IterationPolicy implements Policy {
  private final Policy policy;

  public IterationPolicy() {
    this.policy = new PolicyBuilder()
        .registerCompileTimePass(new InitiationCompositePass())
        .registerCompileTimePass(new LoopExtractionPass())
