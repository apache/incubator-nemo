...
public final class R2OptControlEventHandler implements ControlEventHandler {
  private static final Logger LOG = LoggerFactory.getLogger(R2OptControlEventHandler.class.getName());
  ...
  @Inject
  private R2OptControlEventHandler(
  ...
  public void handleControlEvent(TaskHandlingEvent event) {
    ...
    switch (control.type) {
      ...
      case R2_PIPE_OUTPUT_STOP_SIGNAL_FROM_TASK_TO_CR: {
        ...
        // write signal that i will send data to you
        pipeManagerWorker.writeControlMessage(
          control.getTaskId(), pairEdgeId, pairTaskId,
          TaskControlMessage.TaskControlMessageType
