...
import org.apache.nemo.runtime.executor.common.CpuBottleneckDetector;
...
public final class CpuBottleneckDetectorImpl implements CpuBottleneckDetector {
  private static final Logger LOG = LoggerFactory.getLogger(CpuBottleneckDetectorImpl.class.getName());
  ...
  @Inject
  private CpuBottleneckDetectorImpl(
