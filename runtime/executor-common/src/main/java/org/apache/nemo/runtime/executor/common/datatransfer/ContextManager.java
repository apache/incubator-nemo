 ...
 */
public interface ContextManager extends ChannelInboundHandler {
  ...
  void onContextCloseLocal(int transferIndex);

  void onContextRestartLocal(int transferIndex);

  void onContextStopLocal(int transferIndex);
