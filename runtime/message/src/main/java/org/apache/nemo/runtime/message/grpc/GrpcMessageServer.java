 ...
 * (which is defined in {@link MessageParameters.SenderId}).
 *
 ...
 * @see MessageSender#request(Object)
 */
public final class GrpcMessageServer {
  ...
  private final ConcurrentMap<MessageEnvironment.ListenerType, MessageListener> listenerMap;
   ...
   */
  void setupListener(final MessageEnvironment.ListenerType listenerId,
                     final MessageListener<ControlMessage.Message> listener) {
   ...
   */
  void removeListener(final MessageEnvironment.ListenerType listenerId) {
  ...
  private class MessageService extends MessageServiceGrpc.MessageServiceImplBase {
    ...
    public void send(final ControlMessage.Message message,
      ...
      final MessageListener<ControlMessage.Message> listener =
        listenerMap.get(MessageEnvironment.ListenerType.values()[message.getListenerId()]);
      if (listener == null) {
