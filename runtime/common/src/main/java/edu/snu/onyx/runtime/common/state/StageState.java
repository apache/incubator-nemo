 ...
 */
package edu.snu.onyx.runtime.common.state;

import edu.snu.onyx.common.StateMachine;

/**
 * Represents the states and their transitions of a {@link edu.snu.onyx.runtime.common.plan.physical.PhysicalStage}.
 */
