 ...
 */
@ThreadSafe
public final class DefaultBroadcastManagerWorkerImpl implements BroadcastManagerWorker {
  private static final Logger LOG = LoggerFactory.getLogger(DefaultBroadcastManagerWorkerImpl.class.getName());
  private static DefaultBroadcastManagerWorkerImpl staticReference;
   ...
   */
  @Inject
  private DefaultBroadcastManagerWorkerImpl(@Parameter(JobConf.ExecutorId.class) final String executorId,
   ...
   */
  public static DefaultBroadcastManagerWorkerImpl getStaticReference() {
