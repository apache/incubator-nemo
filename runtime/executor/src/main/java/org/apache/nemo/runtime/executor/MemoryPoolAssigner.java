...
public class MemoryPoolAssigner {
  ...
  public MemoryPoolAssigner(long memorySize) {
    this(memorySize, DEFAULT_PAGE_SIZE);
  }

  public MemoryPoolAssigner(long memorySize, int pageSize) {
  ...
  public void allocatePages(List<MemoryChunk> target, int numPages)
...
//  }
  ...
  static final class MemoryPool {
     ...
     * @param chunk
     */
    void returnChunkToPool(MemoryChunk chunk) {
