...
final class LambdaSideInputProcessor implements SideInputProcessor {
  private static final Logger LOG = LoggerFactory.getLogger(LambdaSideInputProcessor.class.getName());
  ...
  LambdaSideInputProcessor(final SerializerManager serializerManager,
                           final String edgeId,
