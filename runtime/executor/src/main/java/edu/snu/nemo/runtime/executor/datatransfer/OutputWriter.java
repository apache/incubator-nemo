...
public final class OutputWriter extends DataTransfer implements AutoCloseable {
  ...
  private final InterStageDataStoreProperty.Value blockStoreValue;
  ...
  public OutputWriter(final int hashRangeMultiplier,
    ...
    this.blockStoreValue = runtimeEdge.getPropertyValue(InterStageDataStoreProperty.class).get();
