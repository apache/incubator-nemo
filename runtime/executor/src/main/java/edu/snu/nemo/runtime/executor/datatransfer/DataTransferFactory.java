...
public final class DataTransferFactory {
   ...
   */
  public OutputWriter createWriter(final int srcTaskIdx,
                                   final IRVertex dstIRVertex,
                                   final RuntimeEdge<?> runtimeEdge) {
    return new OutputWriter(hashRangeMultiplier, srcTaskIdx, dstIRVertex, runtimeEdge, blockManagerWorker);
  }
