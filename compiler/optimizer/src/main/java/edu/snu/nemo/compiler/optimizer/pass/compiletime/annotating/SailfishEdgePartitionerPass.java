 ...
 */
public final class SailfishEdgePartitionerPass extends AnnotatingPass {
  /**
   * Default constructor.
   */
  public SailfishEdgePartitionerPass() {
    super(PartitionerProperty.class, Collections.singleton(DataCommunicationPatternProperty.class));
  }
