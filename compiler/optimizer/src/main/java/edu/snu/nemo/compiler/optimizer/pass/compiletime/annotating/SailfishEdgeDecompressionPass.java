 ...
 */
public final class SailfishEdgeDecompressionPass extends AnnotatingPass {
  /**
   * Default constructor.
   */
  public SailfishEdgeDecompressionPass() {
    super(DecompressionProperty.class, Collections.singleton(DataCommunicationPatternProperty.class));
  }
