...
import edu.snu.onyx.compiler.optimizer.pass.compiletime.composite.SailfishWOCodecPass;
 ...
 */
public final class SailfishHalfWOCodecPolicy implements Policy {
  private final Policy policy;

  public SailfishHalfWOCodecPolicy() {
    this.policy = new PolicyBuilder(false)
        .registerCompileTimePass(new SailfishWOCodecPass())
