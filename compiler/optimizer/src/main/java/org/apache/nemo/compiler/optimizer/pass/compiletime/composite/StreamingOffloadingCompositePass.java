 ...
 */
public final class StreamingOffloadingCompositePass extends CompositePass {
  /**
   * Default constructor.
   */
  public StreamingOffloadingCompositePass(int parallelism) {
    super(Arrays.asList(
   ...
   * Default constructor.
   */
  public StreamingOffloadingCompositePass() {
    super(Arrays.asList(
