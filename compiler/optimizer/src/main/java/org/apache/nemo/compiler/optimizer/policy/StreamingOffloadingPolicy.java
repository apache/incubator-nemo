 ...
 * Streaming policy.
 */
public final class StreamingOffloadingPolicy implements Policy {
  private Policy policy;

  /**
   * Default constructor.
   */
  public StreamingOffloadingPolicy() {
  ...
  public void build(final int parallelism) {
    ...
    builder.registerCompileTimePass(new StreamingOffloadingCompositePass(parallelism));
