 ...
 * Streaming policy.
 */
public final class StreamingR1R2R3Policy implements Policy {
  private Policy policy;

  /**
   * Default constructor.
   */
  public StreamingR1R2R3Policy() {
  ...
  public void build(final int parallelism) {
    ...
    builder.registerCompileTimePass(new StreamingR3ReshapingPass(parallelism));
