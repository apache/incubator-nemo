...
import org.apache.nemo.compiler.optimizer.pass.compiletime.reshaping.StatefulReshapingPass;
 ...
 */
public final class StreamingStatefulCompositePass extends CompositePass {
  /**
   * Default constructor.
   */
  public StreamingStatefulCompositePass(int parallelism) {
    super(Arrays.asList(
        new DefaultParallelismPass(parallelism, 1),
        new StatefulReshapingPass(),
   ...
   * Default constructor.
   */
  public StreamingStatefulCompositePass() {
    super(Arrays.asList(
