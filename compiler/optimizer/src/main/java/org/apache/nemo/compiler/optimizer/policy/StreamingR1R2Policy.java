...
import org.apache.nemo.compiler.optimizer.pass.compiletime.composite.StreamingR2ReshapingPass;
import org.apache.nemo.compiler.optimizer.pass.runtime.Message;

/**
 * Streaming policy.
 */
public final class StreamingR1R2Policy implements Policy {
  private Policy policy;

  /**
   * Default constructor.
   */
  public StreamingR1R2Policy() {
  ...
  public void build(final int parallelism) {
    ...
    builder.registerCompileTimePass(new StreamingR2ReshapingPass(parallelism));
