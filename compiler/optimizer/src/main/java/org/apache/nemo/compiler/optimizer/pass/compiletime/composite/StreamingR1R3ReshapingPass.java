...
import org.apache.nemo.compiler.optimizer.pass.compiletime.reshaping.*;
 ...
 */
public final class StreamingR1R3ReshapingPass extends CompositePass {
  /**
   * Default constructor.
   */
  public StreamingR1R3ReshapingPass(int parallelism) {
    super(Arrays.asList(
      new DefaultParallelismPass(parallelism, 1),
      new R1ReshapingPass(false),
      new SVToCRReshapingPass(),
      new R3NoR2ReshapingPass(),
   ...
   * Default constructor.
   */
  public StreamingR1R3ReshapingPass() {
    super(Arrays.asList(
